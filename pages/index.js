...
const Home = () => {
  ...
  const copyText = () => {
    ...
    textField.innerText = 'komalsingh54@gmail.com';
  ...
  return (
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <h1 data-text="I'm Komal Singh" className="intro__text">
              <mark className="mark">I&apos;m Komal Singh</mark>
            </h1>
            <p>
              {' '}
              Solution Architect & Full life cycle engineer in London.
          ...
          <br />
          <FooterLink goto='#' /* goto="/about" */>See More About Me</FooterLink>
          <br />
        </PageWrapper>
      </PageSection>
    </Layout>
...
const PageSection = styled.div`
  ...
  .intro__text {
    font-size: calc(var(--font-x-lg) + 12px);
    font-weight: 900;
